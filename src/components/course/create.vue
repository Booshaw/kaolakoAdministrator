  ...
  <div class="p-wrapper">
    <div class="edit-container">
      ...
      <div class="box">
        ...
        <i-input v-model="courseInfo.description" :maxlength="120" type="textarea" style="width:80%"></i-input>
      </div>
      <div class="box">
      ...
      <div class="box">
        ...
        <Upload
          ...
          <div class="logo-img">
            <img height="220" width="300" :src="courseInfo.thumbnailUrl" alt="手记缩略图" v-if="courseInfo.thumbnailUrl">
...
<script>
import { getCategoryTag, getTeacherList, searchVideoHandle } from 'api/getData'
